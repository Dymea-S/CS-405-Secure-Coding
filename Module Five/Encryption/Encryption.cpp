...
*
*  Description:
*  This project demonstrates the implementation of basic file encryption and
*  secure file handling techniques in C++. The application uses XOR-based
*  encryption to encrypt and decrypt text files by applying a repeating
*  password key across each character in the file. In addition to implementing
*  the encryption algorithm, the project includes functionality to read data
*  from a text file into memory and save both encrypted and decrypted data back
*  to text files using the required file format.
*
**************************************************************************/
