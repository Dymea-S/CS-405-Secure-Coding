/**************************************************************************
*  Developer:   Crystal Schippers
*  Course:      SNHU CS 405 - Secure Coding
*  Assignment:  Module Five - Encryption Coding
*  Date:        August 2, 2026
*
*  Description: 
*  This file contains intentionally vulnerable C++ code used to 
*  demonstrate the purpose and effectiveness of static code analysis. The code 
*  includes several common programming and security issues, such as uninitialized 
*  variables, potential buffer overflows, incorrect operators, and 
*  exception-handling problems. The file is analyzed using Cppcheck and Visual 
*  Studio's built-in code analysis tools to identify potential defects, compare 
*  the findings between the two tools, and evaluate the risks associated with 
*  each vulnerability. The project demonstrates how static analysis can identify 
*  problems early in the development process and help developers determine appropriate 
