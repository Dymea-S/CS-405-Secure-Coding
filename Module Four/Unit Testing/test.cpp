/**************************************************************************
*  Name:        Crystal Schippers
*  Course:      CS 405 - Secure Coding
*  Assignment:  Module Four Milestone - Unit Testing
*  Date:        July 26, 2026
*
*  Description:
*  This program demonstrates secure coding principles by implementing
*  Google Test unit tests for the C++ std::vector class. The tests verify
*  expected functionality through both positive and negative test cases,
*  ensuring correct behavior, exception handling, and compliance with
*  industry best practices for software testing.
*
**************************************************************************/
...
TEST_F(CollectionTest, AddFiveElementsUpdatesSize)
{
    // Test that collection is empty.
    EXPECT_TRUE(collection->empty());
...
TEST_F(CollectionTest, EmptiesCollection)
{
    // Test that collection is empty.
    EXPECT_TRUE(collection->empty());
